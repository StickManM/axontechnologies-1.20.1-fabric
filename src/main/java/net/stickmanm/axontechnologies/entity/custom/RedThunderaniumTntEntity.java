...
public class RedThunderaniumTntEntity extends TntEntity {

    // Default constructor for entity type creation
    public RedThunderaniumTntEntity(EntityType<? extends TntEntity> entityType, World world) {
        super(entityType, world);
    }

    // Constructor used when the block is primed
    public RedThunderaniumTntEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter) {
        this(ModEntities.RED_THUNDERANIUM_TNT_ENTITY_TYPE, world); // Use your registered entity type
    ...
    protected void explode() {
        ...
        float explosionPower = 200f; // TNT is 4.0F. 6.0F is a bigger blast.
