...
import net.stickmanm.axontechnologies.entity.custom.AxonAlloyTntEntity;
import net.stickmanm.axontechnologies.entity.custom.RedThunderaniumTntEntity;

public class AxonAlloyTntEntityRenderer extends EntityRenderer<AxonAlloyTntEntity> {

    private final BlockRenderManager blockRenderManager;
    // You don't need the BlockRenderManager field,
    // as the method we call is static.

    public AxonAlloyTntEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
     ...
     */
    @Override
    public void render(AxonAlloyTntEntity myTntEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        ...
        TntMinecartEntityRenderer.renderFlashingBlock(this.blockRenderManager, ModBlocks.AXON_ALLOY_TNT.getDefaultState(), matrixStack, vertexConsumerProvider, i, j / 5 % 2 == 0);
     ...
     */
    @Override
    public Identifier getTexture(AxonAlloyTntEntity myTntEntity) {
