...
public class ThunderaniumTntEntityRenderer extends EntityRenderer<ThunderaniumTntEntity> {

    private final BlockRenderManager blockRenderManager;
    // You don't need the BlockRenderManager field,
    // as the method we call is static.

    public ThunderaniumTntEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
     ...
     */
    @Override
    public void render(ThunderaniumTntEntity myTntEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        ...
        TntMinecartEntityRenderer.renderFlashingBlock(this.blockRenderManager, ModBlocks.THUNDERANIUM_TNT.getDefaultState(), matrixStack, vertexConsumerProvider, i, j / 5 % 2 == 0);
     ...
     */
    @Override
    public Identifier getTexture(ThunderaniumTntEntity myTntEntity) {
