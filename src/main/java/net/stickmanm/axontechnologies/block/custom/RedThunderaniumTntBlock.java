...
public class RedThunderaniumTntBlock extends Block {
    public static final BooleanProperty UNSTABLE;

    public RedThunderaniumTntBlock(Settings settings) {
        super(settings);
    ...
    public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
        if (!world.isClient) {
            RedThunderaniumTntEntity tntEntity = new RedThunderaniumTntEntity(world, (double)pos.getX() + (double)0.5F, (double)pos.getY(), (double)pos.getZ() + (double)0.5F, explosion.getCausingEntity());
    ...
    private static void primeTnt(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        if (!world.isClient) {
            RedThunderaniumTntEntity tntEntity = new RedThunderaniumTntEntity(world, (double)pos.getX() + (double)0.5F, (double)pos.getY(), (double)pos.getZ() + (double)0.5F, igniter);
            world.spawnEntity(tntEntity);
